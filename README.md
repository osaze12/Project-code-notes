  ...
  useEffect(() => {
    if (true) {
      ...
      codePush
            ...
            codePush.sync(
              {
                ...
                updateDialog: {
                  ...
                  mandatoryUpdateMessage: 'There is an update available that needs to be installed.',
        ...
        .catch((er) => console.log('no update sir', er));
      //   }
    }
  }, [isLoading]);
...
https://engineering.classpro.in/react-native-how-settimout-saved-my-life-803346bf18a5
...
#### Formatting number to have 1k, 2k, 5k, 2.5M, (convert million/thousand to M, K)
```javascript
